...
export async function productsRoutes(app: FastifyInstance) {
  ...
  // Cadastro/preço/estoque é gestão de inventário — ADMIN (ou API key com
  // catalog:write, pra um sistema de estoque externo sincronizar direto).
  app.post("/products", { preHandler: requireAdminOrApiKey("catalog:write") }, async (request, reply) => {
